...
/* USER CODE BEGIN PV */
bool green_LED_flag = false; // false - turned off
bool orange_LED_flag = false;
bool red_LED_flag = false;
bool blue_LED_flag = false;
  ...
  while (1)
  {
	  ...
	  if (result == HAL_OK)
	  {
		  switch (rcvBuf[0])
		  {
			...
			case '2':
				orange_LED_flag = !orange_LED_flag;
				if (orange_LED_flag)
				{
			...
			case '6':
				green_LED_flag = false;
				orange_LED_flag = false;
				red_LED_flag = false;
				blue_LED_flag = false;
